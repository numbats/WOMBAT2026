...
::: {style="font-weight: bold; font-size: 4.5rem; line-height: 1;"}
WOMBAT 2026
:::

::: {style="font-size: 1.9rem; font-weight: 600; margin-top: 0.5rem; line-height: 1.2;"}
<span><strong>W</strong>orkshop <strong>O</strong>rganised by the <strong>M</strong>onash <strong>B</strong>usiness <strong>A</strong>nalytics <strong>T</strong>eam.</span>
:::

::: {style="font-size: 2.5rem; letter-spacing: 0.12em; text-transform: uppercase; opacity: 0.7; margin-top: 0.35rem; line-height: 1.05;"}
Save the Date
:::
::: {style="font-size: 2.25rem; font-weight: bold; margin-top: 0.25rem; line-height: 1.15;"}
